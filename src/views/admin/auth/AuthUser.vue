    ...
    <div class="p-[100px] w-full">
      ...
      <div class="form max-w-[594px] w-full">
        ...
        <div class="mb-[20px]">
          ...
          <div class="relative">
            <input class="rounded-[8px] border border-grey-300 bg-white py-[15px] px-[17px] w-full focus:border-indigo-600 text-16sm" id="userPassword" placeholder="Введите пароль" :type="showPassword ? 'text' : 'password'" :class="$v.form.password.$error ? 'is-invalid' : ''"/>
            <div
              class="pass-icon"
        ...
        <div>
          <!-- <button type="submit" class="w-full bg-indigo-600 text-white font-medium py-[13px] px-[20px] rounded-[8px]">Войти</button> -->
